...
import 'package:alterindo/setting/class_pengajuan.dart';
...
class _PengajuanCutiState extends State<PengajuanCuti> {
  ...
  late Future<List<Pengajuan>> dataCuti;
  ...
  DateTime lastDatePick = DateTime.now();
...
// pick date
  ...
  void lastDatePicker() async {
    ...
    if (selectedDate != null && selectedDate != lastDatePick) {
      setState(() {
        lastDatePick = selectedDate;
      });
    }
  }
                ...
                onTap: () {
                  if (izinCode == '0000') {
                    ...
                    sendRequest(
                        ...
                        DateFormat('yyyy-MM-dd').format(lastDatePick),
                        widget.nip,
                        izinCode,
                        _keterangan.text,
                        foto,
